...
{
    public static class BlobStoringDatabaseEfCoreEntityExtensionMappings
    {
        ...
        public static void Configure()
        {
            ...
            OneTimeRunner.Run(() =>
            {
                 ...
                 * USE BlobStoringDatabaseModuleExtensionConfigurator CLASS (in the Domain.Shared project)
