...
namespace BlobStoringDatabase.Users
{
    ...
    public class AppUser : FullAuditedAggregateRoot<Guid>, IUser
    {
         ...
         *
         * 1. Update BlobStoringDatabaseDbContext.OnModelCreating
         * to configure the mapping for your new property
         * 2. Update BlobStoringDatabaseEfCoreEntityExtensionMappings to extend the IdentityUser entity
