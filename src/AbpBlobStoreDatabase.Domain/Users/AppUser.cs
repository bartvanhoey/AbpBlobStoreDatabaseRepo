...
namespace AbpBlobStoreDatabase.Users
{
    ...
    public class AppUser : FullAuditedAggregateRoot<Guid>, IUser
    {
         ...
         *
         * 1. Update AbpBlobStoreDatabaseDbContext.OnModelCreating
         * to configure the mapping for your new property
         * 2. Update AbpBlobStoreDatabaseEfCoreEntityExtensionMappings to extend the IdentityUser entity
