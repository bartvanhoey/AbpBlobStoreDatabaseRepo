...
{
    public static class AbpBlobStoreDatabaseEfCoreEntityExtensionMappings
    {
        ...
        public static void Configure()
        {
            ...
            OneTimeRunner.Run(() =>
            {
                 ...
                 * USE AbpBlobStoreDatabaseModuleExtensionConfigurator CLASS (in the Domain.Shared project)
